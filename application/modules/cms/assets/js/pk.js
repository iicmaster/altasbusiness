		...
		return this.each(function() {  
			...
			$buttonNext.click(function() {	
				...
				if ($indexScroll >= $limitScroll) {
					$("img", this).attr('src', '" + IMAGE_URL + "skin/button_next_off.png');
				}
				$("img", $buttonPrev).attr('src', '" + IMAGE_URL + "skin/button_prev.png');
			});
			$buttonPrev.click(function() {		
				scroll("prev");
				if ($indexScroll <= 0) {
					$("img", this).attr('src', '" + IMAGE_URL + "skin/button_prev_off.png');
				}
				$("img", $buttonNext).attr('src', '" + IMAGE_URL + "skin/button_next.png');
			});	
			
			/**/
			
			if($totalItems > settings.visibleItems) {
				$("img", $buttonPrev).attr('src', '" + IMAGE_URL + "skin/button_prev_off.png');
			}
		});
	};
})(jQuery);
	...
	$.fn.pk_shadows = function(options) {
		...
		return this.each(function () {
			...
			if(!$msie6) {
				...
				$root.prepend("<img src='" + IMAGE_URL + "skin/top_shadow.png' alt='' class='top_shadow' />");
				$root.prepend("<img src='" + IMAGE_URL + "skin/right_shadow.png' alt='' class='right_shadow' />");
